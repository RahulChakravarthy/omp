{**
 * plugins/themes/aosisThemePlugin/lib/pkp/templates/frontend/components/header.tpl
 *
	...
	<div class="pkp_structure_page">
		...
		<header class="pkp_structure_head" id="headerNavigationContainer" role="banner">
			<div class="pkp_head_wrapper">
				...
				<div id="containtop">
<div id="smalltoplogo">image</div>
<div id="tinyquickmenu">
<a href="http://aosis.co.za/publishing" target="_blank">About AOSIS</a>&nbsp;<a href="http://aosis.co.za/policies#policy-tab-2" target="_blank">Policies</a>&nbsp;<a href="http://aosis.co.za/publishing/scholarly-journals" target="_blank">Journals</a>&nbsp;<a href="http://aosis.co.za/publishing/scholarly-books" target="_blank">Books</a>
</div></div>
						...
						{if !$noContextsConfigured}
							...
							<!--<div id="danbookscustomsearch"><form class="pkp_search2" action="{url router=$smarty.const.ROUTE_PAGE page="catalog" op="results"}" method="post" role="search">
							<input name="query" value="{$searchQuery|escape}" type="text" placeholder="Search this website" aria-label="{translate|escape key="common.searchQuery"}">
							<button type="submit">
								{translate key="common.search"}
							</button>
							<div class="search_controls2" aria-hidden="true">
								...
								<a href="#" class="search_cancel2 headerSearchCancel" aria-hidden="true"></a>
								<span class="search_loading2" aria-hidden="true"></span>
							</div>
						</form></div>-->
						<div id="danbookscustomsearch">
						<form class="aosis-library-search-form pkp_search2" method="post" name="search" action="https://library.aosis.co.za/index.php/misearch/results" target="_blank"> 
<label class="aosis-library-search-field-label" for="query"></label>
<input type="hidden" name="isAdvanced" value="1">
<input type="text" id="query" name="query" data-name="query" maxlength="255" value="" class="textFild" placeholder="  Search AOSIS Library"> 
